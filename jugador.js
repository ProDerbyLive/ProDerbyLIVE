...
function cargarVideoYoutube() {
    ...
    contenedor.innerHTML = `
        <div class="pelea-card">
            ...
            <div style="position:relative; width:100%; padding-bottom:56.25%; height:0; overflow:hidden; border-radius:18px;">
                <iframe
                    src="${embedUrl}"
...
setInterval(async () => {
    ...
    const youtubeNuevo = derbyActivo && derbyActivo.youtube_url
        ? obtenerYoutubeEmbed(derbyActivo.youtube_url)
        : "sin-video";

    if (youtubeNuevo !== youtubeAntes) {
        youtubeActual = "";
        cargarVideoYoutube();
    }
